...
~~~sh
# getting the code
git clone git@github.com:nko5/hicapacity.git && cd ./hicapacity/
...
# deploying to Modulus (to http://hicapacity.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/hicapacity" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
